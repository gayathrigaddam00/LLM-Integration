 ...
 * Overview:
 *   • UMD wrapper to support CommonJS, AMD, or global browser use.
 *   • Includes Microsoft tslib helpers (extends, assign, async/await).
 *   • Implements core html2canvas functionality:
 *       – DOM parsing & style computation
 *       – CSS tokenization & parsing (selectors, values, gradients, transforms, etc.)
 *       – Element bounding box measurement and stacking context
 *       – Image loading and caching
 *       – Rendering primitives (shapes, images, text)
 *       – Canvas drawing pipeline and pixel export
 */
